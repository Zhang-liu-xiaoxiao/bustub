...
class LRUKReplacer {
 ...
 private:
  ...
  [[maybe_unused]] size_t start_timestamp_;
  ...
  //! frame id -> (occurrences, can_evicted)
  std::unordered_map<frame_id_t, std::pair<int, bool>> frames_{};
  //! frame -> (visit_index,visit_timestamp)
  std::unordered_map<frame_id_t, std::unordered_map<int, size_t>> frame_visit_time_{};
};
